...
%
\ion{Changed comand names to $a$ and $b$, instead of $x$ and $y$, since we
  use $x$ and $y$ to name the variables.} 
...
two commands $a$ and $b$ \defword{conflict} if they do not commute--i.e.\ there
