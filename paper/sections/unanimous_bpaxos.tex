...
\defword{Unanimous BPaxos} is identical to Incorrect BPaxos except for the
...
Reiterating again \secref{BipartisanPaxos}, to prove the correctness of
...
This concludes the proof of Unanimous BPaxos's correctness, but let's not miss
...
\invref{ConsensusInvariant} and \invref{ConflictInvariant}.  With Incorrect
...
\invref{ConflictInvariant}.  By increasing the fast quorum size, we eliminate
