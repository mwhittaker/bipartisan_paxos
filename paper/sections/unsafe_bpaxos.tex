...
\appendixref{FastPaxos}), with one instance of Fast Paxos for every instance
...
\algoref{FastPaxos} in \appendixref{FastPaxos}, $b_i$ can propose the value
...
$b_i$ then executes \algoref{FastPaxos}. The value $v = (x, \set{I_x})$
...
\invref{ConsensusInvariant} and \invref{ConflictInvariant}. The distinguishing
