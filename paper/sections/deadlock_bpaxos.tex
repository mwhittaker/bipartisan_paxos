...
In this section, we present \defword{Deadlock BPaxos}. Like Unanimous BPaxos,
...
\begin{wrapfigure}{r}{3.6in}
  \begin{minipage}{3.6in}
    \begin{algorithm}[H]
      ...
      \begin{algorithmic}[1]
        \If{$\exists v \in V$ such that $O4(v)$}
          \State $(x, \deps{I}) \gets v$
        \Else{}
          \State send any $v$ satisfying \invref{PrunedDependencies}
        \EndIf{}
        ...
        \For{$I' \in \deps{I}' - \deps{I}$}
          \If{$b_i$ doesn't know that $I'$ is chosen}
