\begin{wrapfigure}{r}{0.3\textwidth}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \tikzstyle{vertex}=[draw, align=center, minimum width=0.3in,
    minimum height=0.2in, inner sep=2pt]
    \tikzstyle{vertexlabel}=[label distance=-2pt, flatred]
    \tikzstyle{arrow}=[line width=0.75pt, -latex]
    \begin{tikzpicture}[xscale=1.2, yscale=1.5]
      \node[vertex, label={[vertexlabel]-90:$I_1$}] (x1y2) at (0, 0)
        {\texttt{x=1}\\[-3pt]\texttt{y=2}};
      \node[vertex, label={[vertexlabel]-90:$I_2$}] (x2) at (1, 0.5)
        {\texttt{x=2}};
      \node[vertex, label={[vertexlabel]-90:$I_3$}] (y1) at (1, -0.5)
        {\texttt{y=1}};
      \node[vertex, label={[vertexlabel]-90:$I_4$}] (x3y4) at (2, 0)
        {\texttt{x=3}\\[-3pt]\texttt{y=4}};
      \node[vertex, label={[vertexlabel]-90:$I_5$}] (x22) at (3, 0)
        {\texttt{x=2}};
