% TODO(mwhittaker): Hoist into a different file.
...
\begin{figure}
  \begin{subfigure}[t]{0.45\columnwidth}
    \centering
    \begin{tikzpicture}
      \multipaxoslog{$a \gets 0$}{}%
                    {}{}%
                    {}{}
    \end{tikzpicture}
    \caption{%
      $a \gets 0$ is chosen in entry $\textcolor{\logindexcolor}{0}$.
    }
  ...
  \begin{subfigure}[t]{0.45\columnwidth}
    \centering
    \begin{tikzpicture}
      \multipaxoslog{$a \gets 0$}{executed}%
                    {}{}%
                    {}{}
    \end{tikzpicture}
    \caption{%
      $a \gets 0$ is executed.
    }
  ...
  \begin{subfigure}[t]{0.45\columnwidth}
    ...
    \end{tikzpicture}
    \caption{%
      $b \gets 2$ is chosen in entry $\textcolor{\logindexcolor}{2}$.
    }
  ...
  \begin{subfigure}[t]{0.45\columnwidth}
    ...
    \end{tikzpicture}
    \caption{%
      $a \gets 1$ is chosen in entry $\textcolor{\logindexcolor}{1}$.
    }
  ...
  \begin{subfigure}[t]{0.45\columnwidth}
    ...
    \end{tikzpicture}
    \caption{%
      $b \gets 1$, $b \gets 2$ are executed.
    }
    \figlabel{ExampleMultiPaxosExecutionF}
  \end{subfigure}

  \caption{Example MultiPaxos execution}
