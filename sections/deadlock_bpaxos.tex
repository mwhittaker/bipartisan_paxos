...
\TODO[mwhittaker]{%
  Explain that based on what the remaining 4 nodes did, we could have any four
  of the five commands committed and we don't know which. Thus, we're
  completely stuck. We can't improve the algorithm. We have to change the
  algorithm.
}
