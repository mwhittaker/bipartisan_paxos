...
\defword{acceptors}, as illustrated in \figref{Paxos}.
%
...
the client. This execution is illustrated in \figref{Paxos}.
...
sync. This is illustrated in \figref{LogOverTime}.
...
well as at least $f+1$ replicas, as illustrated in \figref{MultiPaxos}.
