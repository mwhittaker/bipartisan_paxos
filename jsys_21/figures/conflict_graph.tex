\begin{figure}
  ...
  \begin{subfigure}[c]{0.2\textwidth}
    ...
    \begin{tikzpicture}[xscale=1, yscale=1.5]
      ...
      \node[logentry, label={[logindex]90:4}, right=\rightof{3}] (4) {\texttt{a=3}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.25\textwidth}
    ...
    \begin{tikzpicture}[xscale=1.2, yscale=1.5]
      ...
      \node[vertex, draw=flatpurple, fill=flatpurple!10, label={[vertexlabel]-90:$v_4$}] (x22) at (3, 0) {\texttt{a=3}};
      ...
      \draw[arrow, bend right] (x22) to (x2);
